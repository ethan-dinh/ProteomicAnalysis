...
```{r}
data_path = "Data/Soma plus MGH normalized measures.csv"
meta_path = "Data/Soma plus MGH repeat measures meta.csv"

mSet <- InitDataObjects("conc", "mf", FALSE)
mSet <- SetDesignType(mSet, "Time")

mSet<-Read.TextDataTs(mSet, "Data/Soma plus MGH normalized measures (NO T1).csv", "rowmf");
mSet<-ReadMetaData(mSet, "Data/Soma plus MGH repeat measures meta (NO T1).csv");
