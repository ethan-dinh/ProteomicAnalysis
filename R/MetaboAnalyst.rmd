...
```{r}
data_path = "Data/Soma plus MGH repeat measures.csv"
meta_path = "Data/Soma plus MGH repeat measures meta.csv"

mSet <- InitDataObjects("conc", "mf", FALSE)
mSet <- SetDesignType(mSet, "Time")

mSet<-Read.TextDataTs(mSet, "Data/Soma plus MGH repeat measures.csv", "rowmf");
mSet<-ReadMetaData(mSet, "Data/Soma plus MGH repeat measures meta.csv");
